...
Future<List<FeedbackEsdeveniments>> http_getfeedback(
    String cookie, int eventid) async {
  print('Entra');
  final String apitUrl = "http://10.4.41.148:8080/event/feedback/get";
  var queryParamaters = {'EventId': eventid, 'cookie': cookie};
  ...
  if (response.statusCode == 201 || response.statusCode == 200) {
    ...
    final List<FeedbackEsdeveniments> list =
        feedbackEsdevenimentsFromJson(utf8.decode(response.bodyBytes));
